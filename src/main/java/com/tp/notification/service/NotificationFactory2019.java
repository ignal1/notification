...
class NotificationFactory2019 {
    ...
    private List<‘айл.ƒокумент.”в онтр—д.—в онтр—д> transactionsFilling(){
        List<‘айл.ƒокумент.”в онтр—д.—в онтр—д> св онтр—д—писок = null;
        if(transactions.size() != 0){
            св онтр—д—писок = new ArrayList<>();
            for(String[] item : transactions){
                ‘айл.ƒокумент.”в онтр—д.—в онтр—д св онтр—д = new ‘айл.ƒокумент.”в онтр—д.—в онтр—д();
    ...
    private List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вќрг”част> свќрг”частћетод(Integer numOfTransaction){
        List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вќрг”част> свќрг”част—писок = null;
        if(partiesOrganizations.size() != 0){
            ...
            for(String[] item : partiesOrganizations){
                if(Integer.parseInt(item[0]) == numOfTransaction){
                    ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вќрг”част свќрг”част = new ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вќрг”част();
    ...
    private ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част.—в‘Ћ св‘Ћћетод(int index){
        ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част.—в‘Ћ св‘Ћ = null;
        ...
        if(дата–ожд != null || место–ожд != null || гражд != null || оксм != null ||
            ...
            св‘Ћ = new ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част.—в‘Ћ();
    ...
    private List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част> св‘Ћ”частћетод(Integer numOfTransaction){
        List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част> св‘Ћ”част—писок = null;
        if(partiesPersons.size() != 0){
            св‘Ћ”част—писок = new ArrayList<>();
            int counter = 0;
            for(String[] item : partiesPersons){
                if(Integer.parseInt(item[0]) == numOfTransaction){
                    ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част св‘Ћ”част = new ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част();
    ...
    private ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ.ѕерѕред—д перѕред—дћетод(int index){
        ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ.ѕерѕред—д перѕред—д = null;
        ...
        if(наимѕред—д != null || тнвэд != null || окпд2 != null || оквэд2 != null
            ...
            перѕред—д = new ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ.ѕерѕред—д();
    ...
    private List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ> свѕредм—дЌћетод(Integer numOfTransaction){
        List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ> свѕредм—дЌ—писок = null;
        if(subjects.size() != 0){
            свѕредм—дЌ—писок = new ArrayList<>();
            Map<String, ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ> map = new HashMap<>();
            int counter = 0;
            for(String[] item : subjects){
                if(Integer.parseInt(item[0]) == numOfTransaction){
                    if(!map.containsKey(item[1])){
                        ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ свѕредм—дЌ = new ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ();
                        свѕредм—дЌ.set“ипѕред—д(item[1]);
                        List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ.ѕерѕред—д> перѕред—д—писок = new ArrayList<>();
                        перѕред—д—писок.add(перѕред—дћетод(counter));
                        свѕредм—дЌ.setѕерѕред—д(перѕред—д—писок);
                        map.put(item[1], свѕредм—дЌ);
                    }
                    else{
                        ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ свѕредм—дЌ = map.get(item[1]);
                        свѕредм—дЌ.getѕерѕред—д().add(перѕред—дћетод(counter));
                    }
                }
                counter++;
            }
            for(Map.Entry<String, ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ> item : map.entrySet()){
    ...
    private ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ƒох–асх—д дох–асх—дћетод(Integer numOfTransaction){
        ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ƒох–асх—д дох–асх—д = null;
        String сумƒох—д = transactions.get(numOfTransaction)[35];
        String сумƒох—д–ег = transactions.get(numOfTransaction)[36];
        String сум–асх—д = transactions.get(numOfTransaction)[37];
        String сум–асх—д–ег = transactions.get(numOfTransaction)[38];
        if(сумƒох—д != null || сумƒох—д–ег != null || сум–асх—д != null || сум–асх—д–ег != null){
            дох–асх—д = new ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ƒох–асх—д();
    ...
    private ‘айл.ƒокумент.”в онтр—д.—в онтр—д. онтр—д. од»ст»нф код»ст»нфћетод(Integer numOfTransaction){
        ‘айл.ƒокумент.”в онтр—д.—в онтр—д. онтр—д. од»ст»нф код»ст»нф = null;
        ...
        if(ист251 != null || ист252 != null || ист253 != null || ист254 != null || ист255 != null ||
            ...
            код»ст»нф = new ‘айл.ƒокумент.”в онтр—д.—в онтр—д. онтр—д. од»ст»нф();
    ...
    private ‘айл.ƒокумент.”в онтр—д.—в онтр—д. онтр—д контр—дћетод(Integer numOfTransaction){
        ‘айл.ƒокумент.”в онтр—д.—в онтр—д. онтр—д контр—д = null;
        ‘айл.ƒокумент.”в онтр—д.—в онтр—д. онтр—д. од»ст»нф код»ст»нф = код»ст»нфћетод(numOfTransaction);
        String групќ— = transactions.get(numOfTransaction)[15];
        String кодЌаим—д = transactions.get(numOfTransaction)[16];
        String код—тор—д = transactions.get(numOfTransaction)[17];
        String прќпр÷ен = transactions.get(numOfTransaction)[18];
        String комѕрќпр÷ен = transactions.get(numOfTransaction)[19];
        String кодќпр÷ен = transactions.get(numOfTransaction)[20];
        String ком одќпр÷ен = transactions.get(numOfTransaction)[21];
        String кодћет÷ен = transactions.get(numOfTransaction)[22];
        String ком одћет÷ен = transactions.get(numOfTransaction)[23];
        String кол”ч—д = transactions.get(numOfTransaction)[24];
        String ком ол”ч—д = transactions.get(numOfTransaction)[25];
        if(код»ст»нф != null || групќ— != null || кодЌаим—д != null || код—тор—д != null || прќпр÷ен != null ||
            ...
            контр—д = new ‘айл.ƒокумент.”в онтр—д.—в онтр—д. онтр—д();
    ...
    private ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн10514 осн10514ћетод(Integer numOfTransaction){
        ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн10514 осн10514 = null;
        ...
        if(осн121 != null || осн122 != null || осн123 != null || осн124 != null){
            осн10514 = new ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн10514();
    ...
    private ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн–‘10514 осн–‘10514ћетод(Integer numOfTransaction){
        ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн–‘10514 осн–‘10514 = null;
        ...
        if(осн131 != null || осн132 != null || осн133 != null || осн134 != null
            ...
            осн–‘10514 = new ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн–‘10514();
    ...
    private ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д осн онтр—дћетод(Integer numOfTransaction){
        ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д осн онтр—д = null;
        ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн10514 осн10514 = осн10514ћетод(numOfTransaction);
        ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн–‘10514 осн–‘10514 = осн–‘10514ћетод(numOfTransaction);
        String вз«авис = transactions.get(numOfTransaction)[2];
        if(осн10514 != null || осн–‘10514 != null || вз«авис != null){
            осн онтр—д = new ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д();
    ...
    ‘айл populateClasses(){
        ...
        ‘айл.ƒокумент.—вЌѕ.Ќѕ‘Ћ.—в‘Ћ св‘Ћ = null;
        if(удЋичн‘Ћ“ип != null || адр»н“ип != null || taxpayer.get(43) != null
            ...
            св‘Ћ = new ‘айл.ƒокумент.—вЌѕ.Ќѕ‘Ћ.—в‘Ћ();
            св‘Ћ.set”дЋичн‘Ћ(удЋичн‘Ћ“ип);
            св‘Ћ.setјдр»н(адр»н“ип);
        ...
        ‘айл.ƒокумент.ѕодписант.—вѕред свѕред = null;
        if (taxpayer.get(26) != null || taxpayer.get(27) != null){
            свѕред = new ‘айл.ƒокумент.ѕодписант.—вѕред();
        ...
        ‘айл.ƒокумент.ѕодписант подписант = null;
        if (фио“ип1 != null || свѕред != null || taxpayer.get(20) != null){
            подписант = new ‘айл.ƒокумент.ѕодписант();
            подписант.set‘»ќ(фио“ип1);
            подписант.set—вѕред(свѕред);
            подписант.setѕрѕодп(taxpayer.get(20));
        }

        List<‘айл.ƒокумент.”в онтр—д.—в онтр—д> св онтр—д = transactionsFilling();
        ‘айл.ƒокумент.”в онтр—д ув онтр—д = null;
        if(св онтр—д != null){
            ув онтр—д = new ‘айл.ƒокумент.”в онтр—д();
            ув онтр—д.set—в онтр—д(св онтр—д);
        }

        ‘айл.ƒокумент документ = null;
        ...
        if (документ != null || taxpayer.get(1) != null || taxpayer.get(2) != null
            ...
            файл = new ‘айл();
            файл.setƒокумент(документ);
            файл.set»д‘айл(taxpayer.get(1));
            файл.set¬ерсѕрог(taxpayer.get(2));
            файл.set¬ерс‘орм(taxpayer.get(3));
            файл.set»д‘айл»сх(taxpayer.get(4));
            файл.set»д‘айлѕерв(taxpayer.get(5));
            файл.set ол‘айл(taxpayer.get(6));
            файл.setЌом‘айл(taxpayer.get(7));
        }
        return файл;
    }
}
