...
public class ‘айл2012 {

    @XmlElement(name = "ƒокумент", required = true)
    protected ‘айл2012.ƒокумент документ;
    ...
    public ‘айл2012.ƒокумент getƒокумент() {
        return документ;
    }
    public void setƒокумент(‘айл2012.ƒокумент value) {
        this.документ = value;
    }
    ...
    public String get¬ерс‘орм() { return верс‘орм; }
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = { "свЌѕ", "подписант", "ув онтр—д" })
    public static class ƒокумент {

        @XmlElement(name = "—вЌѕ", required = true)
        protected ‘айл2012.ƒокумент.—вЌѕ свЌѕ;
        @XmlElement(name = "ѕодписант", required = true)
        protected ‘айл2012.ƒокумент.ѕодписант подписант;
        @XmlElement(name = "”в онтр—д", required = true)
        protected ‘айл2012.ƒокумент.”в онтр—д ув онтр—д;
        ...
        public ‘айл2012.ƒокумент.—вЌѕ get—вЌѕ() {
            return свЌѕ;
        }
        public void set—вЌѕ(‘айл2012.ƒокумент.—вЌѕ value) {
            this.свЌѕ = value;
        }
        public ‘айл2012.ƒокумент.ѕодписант getѕодписант() {
            return подписант;
        }
        public void setѕодписант(‘айл2012.ƒокумент.ѕодписант value) {
            this.подписант = value;
        }
        public ‘айл2012.ƒокумент.”в онтр—д get”в онтр—д() {
            return ув онтр—д;
        }
        public void set”в онтр—д(‘айл2012.ƒокумент.”в онтр—д value) {
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "", propOrder = { "фио", "свѕред" })
        public static class ѕодписант {

            @XmlElement(name = "‘»ќ")
            protected ‘»ќ“ип фио;
            @XmlElement(name = "—вѕред")
            protected ‘айл2012.ƒокумент.ѕодписант.—вѕред свѕред;
            ...
            public ‘айл2012.ƒокумент.ѕодписант.—вѕред get—вѕред() {
                return свѕред;
            }
            public void set—вѕред(‘айл2012.ƒокумент.ѕодписант.—вѕред value) {
                this.свѕред = value;
            }
        ...
        public static class —вЌѕ {
            ...
            protected ‘айл2012.ƒокумент.—вЌѕ.ЌѕёЋ нпюл;
            @XmlElement(name = "Ќѕ‘Ћ")
            protected ‘айл2012.ƒокумент.—вЌѕ.Ќѕ‘Ћ нпфл;

            @XmlAttribute(name = "ќ ј“ќ", required = true)
            ...
            public ‘айл2012.ƒокумент.—вЌѕ.ЌѕёЋ getЌѕёЋ() {
                return нпюл;
            }
            public void setЌѕёЋ(‘айл2012.ƒокумент.—вЌѕ.ЌѕёЋ value) {
                this.нпюл = value;
            }
            public ‘айл2012.ƒокумент.—вЌѕ.Ќѕ‘Ћ getЌѕ‘Ћ() {
                return нпфл;
            }
            public void setЌѕ‘Ћ(‘айл2012.ƒокумент.—вЌѕ.Ќѕ‘Ћ value) {
                this.нпфл = value;
            }
            public String getќ ј“ќ() {
                return окато;
            }
            public void setќ ј“ќ(String value) {
                this.окато = value;
            }
            public String getќ ¬Ёƒ() {
                return оквэд;
            }
            public void setќ ¬Ёƒ(String value) {
                this.оквэд = value;
            }
            ...
            @XmlAccessorType(XmlAccessType.FIELD)
            @XmlType(name = "", propOrder = { "фио", "иннфл", "св‘Ћ" })
            public static class Ќѕ‘Ћ {
                ...
                @XmlElement(name = "—в‘Ћ")
                protected ‘айл2012.ƒокумент.—вЌѕ.Ќѕ‘Ћ.—в‘Ћ св‘Ћ;
                ...
                public ‘айл2012.ƒокумент.—вЌѕ.Ќѕ‘Ћ.—в‘Ћ get—в‘Ћ() {
                    return св‘Ћ;
                }
                public void set—в‘Ћ(‘айл2012.ƒокумент.—вЌѕ.Ќѕ‘Ћ.—в‘Ћ value) {
                    this.св‘Ћ = value;
                }


                @XmlAccessorType(XmlAccessType.FIELD)
                @XmlType(name = "", propOrder = { "удЋичн‘Ћ", "свјдр–‘", "адр»н" })
                public static class —в‘Ћ {

                    @XmlElement(name = "”дЋичн‘Ћ", required = true)
                    protected ”дЋичн‘Ћ“ип удЋичн‘Ћ;
                    @XmlElement(name = "—вјдр–‘", required = true)
                    protected —вјдр–‘“ип свјдр–‘;
                    ...
                    @XmlAttribute(name = "Ќал√ражд", required = true)
                    protected String нал√ражд;
                    ...
                    public —вјдр–‘“ип get—вјдр–‘() {
                        return свјдр–‘;
                    }
                    public void set—вјдр–‘(—вјдр–‘“ип value) {
                        this.свјдр–‘ = value;
                    }
                    ...
                    public String getЌал√ражд() {
                        return нал√ражд;
                    }
                    public void setЌал√ражд(String value) {
                        this.нал√ражд = value;
                    }
            ...
            @XmlAccessorType(XmlAccessType.FIELD)
            @XmlType(name = "", propOrder = { "св–еоргёЋ" })
            public static class ЌѕёЋ {

                @XmlElement(name = "—в–еоргёЋ")
                protected ‘айл2012.ƒокумент.—вЌѕ.ЌѕёЋ.—в–еоргёЋ св–еоргёЋ;
                ...
                public ‘айл2012.ƒокумент.—вЌѕ.ЌѕёЋ.—в–еоргёЋ get—в–еоргёЋ() {
                    return св–еоргёЋ;
                }
                public void set—в–еоргёЋ(‘айл2012.ƒокумент.—вЌѕ.ЌѕёЋ.—в–еоргёЋ value) {
        ...
        @XmlAccessorType(XmlAccessType.FIELD)
        @XmlType(name = "", propOrder = { "св онтр—д" })
        public static class ”в онтр—д {

            @XmlElement(name = "—в онтр—д", required = true)
            protected List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д> св онтр—д;

            public List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д> get—в онтр—д() {
                if (св онтр—д == null) {
                    св онтр—д = new ArrayList<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д>();
                }
                return this.св онтр—д;
            }
            public void set—в онтр—д(List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д> value) {
                this.св онтр—д = value;
            }

            @XmlAccessorType(XmlAccessType.FIELD)
            @XmlType(name = "", propOrder = { "осн онтр—д", "контр—д", "дох–асх—д", "свѕредм—д", "свќрг”част", "св‘Ћ”част" })
            public static class —в онтр—д {

                @XmlElement(name = "ќсн онтр—д", required = true)
                protected ‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д осн онтр—д;
                @XmlElement(name = " онтр—д", required = true)
                protected ‘айл2012.ƒокумент.”в онтр—д.—в онтр—д. онтр—д контр—д;
                @XmlElement(name = "ƒох–асх—д", required = true)
                protected ‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.ƒох–асх—д дох–асх—д;
                @XmlElement(name = "—вѕредм—д", required = true)
                protected List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—д> свѕредм—д;
                @XmlElement(name = "—вќрг”част")
                protected List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—вќрг”част> свќрг”част;
                @XmlElement(name = "—в‘Ћ”част")
                protected List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част> св‘Ћ”част;

                @XmlAttribute(name = "Ќомѕор—д", required = true)
                protected BigInteger номѕор—д;

                public ‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д getќсн онтр—д() {
                    return осн онтр—д;
                }
                public void setќсн онтр—д(‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д value) {
                    this.осн онтр—д = value;
                }
                public ‘айл2012.ƒокумент.”в онтр—д.—в онтр—д. онтр—д get онтр—д() {
                    return контр—д;
                }
                public void set онтр—д(‘айл2012.ƒокумент.”в онтр—д.—в онтр—д. онтр—д value) {
                    this.контр—д = value;
                }
                public ‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.ƒох–асх—д getƒох–асх—д() {
                    return дох–асх—д;
                }
                public void setƒох–асх—д(‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.ƒох–асх—д value) {
                    this.дох–асх—д = value;
                }
                public List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—д> get—вѕредм—д() {
                    if (свѕредм—д == null) {
                        свѕредм—д = new ArrayList<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—д>();
                    }
                    return this.свѕредм—д;
                }
                public void set—вѕредм—д(List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—д> value){
                    this.свѕредм—д = value;
                }
                public List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—вќрг”част> get—вќрг”част() {
                    if (свќрг”част == null) {
                        свќрг”част = new ArrayList<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—вќрг”част>();
                    }
                    return this.свќрг”част;
                }
                public void set—вќрг”част(List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—вќрг”част> value){
                    this.свќрг”част = value;
                }
                public List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част> get—в‘Ћ”част() {
                    if (св‘Ћ”част == null) {
                        св‘Ћ”част = new ArrayList<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част>();
                    }
                    return this.св‘Ћ”част;
                }
                public void set—в‘Ћ”част(List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част> value){
                ...
                @XmlAccessorType(XmlAccessType.FIELD)
                @XmlType(name = "", propOrder = { "код»ст»нф" })
                public static class  онтр—д {

                    @XmlElement(name = " од»ст»нф")
                    protected ‘айл2012.ƒокумент.”в онтр—д.—в онтр—д. онтр—д. од»ст»нф код»ст»нф;
                    ...
                    public ‘айл2012.ƒокумент.”в онтр—д.—в онтр—д. онтр—д. од»ст»нф get од»ст»нф() {
                        return код»ст»нф;
                    }
                    public void set од»ст»нф(‘айл2012.ƒокумент.”в онтр—д.—в онтр—д. онтр—д. од»ст»нф value) {
                ...
                @XmlAccessorType(XmlAccessType.FIELD)
                @XmlType(name = "", propOrder = { "осн10514", "осн–‘10514" })
                public static class ќсн онтр—д {

                    @XmlElement(name = "ќсн105.14", required = true)
                    protected ‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн10514 осн10514;
                    @XmlElement(name = "ќсн–‘105.14", required = true)
                    protected ‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн–‘10514 осн–‘10514;

                    @XmlAttribute(name = "¬з«авис")
                    protected String вз«авис;

                    public ‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн10514 getќсн10514() {
                        return осн10514;
                    }
                    public void setќсн10514(‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн10514 value) {
                        this.осн10514 = value;
                    }
                    public ‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн–‘10514 getќсн–‘10514() {
                        return осн–‘10514;
                    }
                    public void setќсн–‘10514(‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн–‘10514 value) {
                    ...
                    public static class ќсн–‘10514 {
                        ...
                        public String getќсн132() { return осн132; }
                ...
                @XmlAccessorType(XmlAccessType.FIELD)
                @XmlType(name = "", propOrder = { "перѕред—д" })
                public static class —вѕредм—д {

                    @XmlElement(name = "ѕерѕред—д", required = true)
                    protected List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—д.ѕерѕред—д> перѕред—д;

                    @XmlAttribute(name = "“ипѕред—д", required = true)
                    protected String типѕред—д;

                    public List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—д.ѕерѕред—д> getѕерѕред—д() {
                        if (перѕред—д == null) {
                            перѕред—д = new ArrayList<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—д.ѕерѕред—д>();
                        }
                        return this.перѕред—д;
                    }
                    public void setѕерѕред—д(List<‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—д.ѕерѕред—д> value){
                    ...
                    @XmlAccessorType(XmlAccessType.FIELD)
                    @XmlType(name = "", propOrder = { "местќтпр“ов", "мест—ов—д" })
                    public static class ѕерѕред—д {
                        ...
                        @XmlAttribute(name = "ќ ≈»", required = true)
                        protected String океи;
                        @XmlAttribute(name = " оличество", required = true)
                        protected BigInteger количество;
                        @XmlAttribute(name = "÷ена≈дин", required = true)
                        protected BigInteger цена≈дин;
                        @XmlAttribute(name = "—тоим»тог", required = true)
                        ...
                        public String getќ ѕ() {
                            return окп;
                        }
                        public void setќ ѕ(String value) {
                            this.окп = value;
                        }
                        public String getќ ¬Ёƒ() {
                            return оквэд;
                        ...
                        public BigInteger get оличество() {
                            return количество;
                        }
                        public void set оличество(BigInteger value) {
                            this.количество = value;
                        }
                        public BigInteger get÷ена≈дин() {
                            return цена≈дин;
                        }
                        public void set÷ена≈дин(BigInteger value) {
                            this.цена≈дин = value;
                        }
                ...
                public static class —в‘Ћ”част {
                    ...
                    protected String иннфл;
                    @XmlElement(name = "—в‘Ћ")
                    protected ‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част.—в‘Ћ св‘Ћ;
                    ...
                    public ‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част.—в‘Ћ get—в‘Ћ() {
                        return св‘Ћ;
                    }
                    public void set—в‘Ћ(‘айл2012.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част.—в‘Ћ value) {
                        this.св‘Ћ = value;
                    }
                    public BigInteger getЌомѕор—д() {
                        return номѕор—д;
