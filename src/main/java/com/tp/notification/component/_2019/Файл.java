...
public class Файл {
    ...
    public static class Документ {
        ...
        protected Файл.Документ.СвНП свНП;
        ...
        protected Файл.Документ.УвКонтрСд увКонтрСд;
        ...
        public Файл.Документ.СвНП getСвНП() {
            return свНП;
        }
        public void setСвНП(Файл.Документ.СвНП value) {
            this.свНП = value;
        }
        ...
        public Файл.Документ.УвКонтрСд getУвКонтрСд() {
            return увКонтрСд;
        }
        public void setУвКонтрСд(Файл.Документ.УвКонтрСд value) {
        ...
        public static class Подписант {
            ...
            protected Файл.Документ.Подписант.СвПред свПред;
            ...
            public Файл.Документ.Подписант.СвПред getСвПред() {
                return свПред;
            }
            public void setСвПред(Файл.Документ.Подписант.СвПред value) {
                this.свПред = value;
            }
        ...
        public static class СвНП {
            ...
            protected Файл.Документ.СвНП.НПЮЛ нпюл;
            @XmlElement(name = "НПФЛ")
            protected Файл.Документ.СвНП.НПФЛ нпфл;
            ...
            public Файл.Документ.СвНП.НПЮЛ getНПЮЛ() {
                return нпюл;
            }
            public void setНПЮЛ(Файл.Документ.СвНП.НПЮЛ value) {
                this.нпюл = value;
            }
            public Файл.Документ.СвНП.НПФЛ getНПФЛ() {
                return нпфл;
            }
            public void setНПФЛ(Файл.Документ.СвНП.НПФЛ value) {
                this.нпфл = value;
            }
            ...
            public static class НПФЛ {
                ...
                protected Файл.Документ.СвНП.НПФЛ.СвФЛ свФЛ;
                ...
                public Файл.Документ.СвНП.НПФЛ.СвФЛ getСвФЛ() {
                    return свФЛ;
                }
                public void setСвФЛ(Файл.Документ.СвНП.НПФЛ.СвФЛ value) {
                    this.свФЛ = value;
                }
            ...
            public static class НПЮЛ {
                ...
                protected Файл.Документ.СвНП.НПЮЛ.СвРеоргЮЛ свРеоргЮЛ;
                ...
                public Файл.Документ.СвНП.НПЮЛ.СвРеоргЮЛ getСвРеоргЮЛ() {
                    return свРеоргЮЛ;
                }
                public void setСвРеоргЮЛ(Файл.Документ.СвНП.НПЮЛ.СвРеоргЮЛ value) {
        ...
        public static class УвКонтрСд {
            ...
            protected List<Файл.Документ.УвКонтрСд.СвКонтрСд> свКонтрСд;

            public List<Файл.Документ.УвКонтрСд.СвКонтрСд> getСвКонтрСд() {
                if (свКонтрСд == null) {
                    свКонтрСд = new ArrayList<Файл.Документ.УвКонтрСд.СвКонтрСд>();
                }
                return this.свКонтрСд;
            }

            public void setСвКонтрСд(List<Файл.Документ.УвКонтрСд.СвКонтрСд> value) {
            ...
            public static class СвКонтрСд {
                ...
                protected Файл.Документ.УвКонтрСд.СвКонтрСд.ОснКонтрСд оснКонтрСд;
                @XmlElement(name = "КонтрСд", required = true)
                protected Файл.Документ.УвКонтрСд.СвКонтрСд.КонтрСд контрСд;
                @XmlElement(name = "ДохРасхСд", required = true)
                protected Файл.Документ.УвКонтрСд.СвКонтрСд.ДохРасхСд дохРасхСд;
                @XmlElement(name = "СвПредмСдН", required = true)
                protected List<Файл.Документ.УвКонтрСд.СвКонтрСд.СвПредмСдН> свПредмСдН;
                @XmlElement(name = "СвОргУчаст")
                protected List<Файл.Документ.УвКонтрСд.СвКонтрСд.СвОргУчаст> свОргУчаст;
                @XmlElement(name = "СвФЛУчаст")
                protected List<Файл.Документ.УвКонтрСд.СвКонтрСд.СвФЛУчаст> свФЛУчаст;
                ...
                public Файл.Документ.УвКонтрСд.СвКонтрСд.ОснКонтрСд getОснКонтрСд() {
                    return оснКонтрСд;
                }
                public void setОснКонтрСд(Файл.Документ.УвКонтрСд.СвКонтрСд.ОснКонтрСд value) {
                    this.оснКонтрСд = value;
                }
                public Файл.Документ.УвКонтрСд.СвКонтрСд.КонтрСд getКонтрСд() {
                    return контрСд;
                }
                public void setКонтрСд(Файл.Документ.УвКонтрСд.СвКонтрСд.КонтрСд value) {
                    this.контрСд = value;
                }
                public Файл.Документ.УвКонтрСд.СвКонтрСд.ДохРасхСд getДохРасхСд() {
                    return дохРасхСд;
                }
                public void setДохРасхСд(Файл.Документ.УвКонтрСд.СвКонтрСд.ДохРасхСд value) {
                    this.дохРасхСд = value;
                }

                public List<Файл.Документ.УвКонтрСд.СвКонтрСд.СвПредмСдН> getСвПредмСдН() {
                    if (свПредмСдН == null) {
                        свПредмСдН = new ArrayList<Файл.Документ.УвКонтрСд.СвКонтрСд.СвПредмСдН>();
                    }
                    return this.свПредмСдН;
                }
                public void setСвПредмСдН(List<Файл.Документ.УвКонтрСд.СвКонтрСд.СвПредмСдН> value){
                    this.свПредмСдН = value;
                }

                public List<Файл.Документ.УвКонтрСд.СвКонтрСд.СвОргУчаст> getСвОргУчаст() {
                    if (свОргУчаст == null) {
                        свОргУчаст = new ArrayList<Файл.Документ.УвКонтрСд.СвКонтрСд.СвОргУчаст>();
                    }
                    return this.свОргУчаст;
                }
                public void setСвОргУчаст(List<Файл.Документ.УвКонтрСд.СвКонтрСд.СвОргУчаст> value){
                    this.свОргУчаст = value;
                }

                public List<Файл.Документ.УвКонтрСд.СвКонтрСд.СвФЛУчаст> getСвФЛУчаст() {
                    if (свФЛУчаст == null) {
                        свФЛУчаст = new ArrayList<Файл.Документ.УвКонтрСд.СвКонтрСд.СвФЛУчаст>();
                    }
                    return this.свФЛУчаст;
                }
                public void setСвФЛУчаст(List<Файл.Документ.УвКонтрСд.СвКонтрСд.СвФЛУчаст> value){
                ...
                public static class КонтрСд {
                    ...
                    protected Файл.Документ.УвКонтрСд.СвКонтрСд.КонтрСд.КодИстИнф кодИстИнф;
                    ...
                    public Файл.Документ.УвКонтрСд.СвКонтрСд.КонтрСд.КодИстИнф getКодИстИнф() {
                        return кодИстИнф;
                    }
                    public void setКодИстИнф(Файл.Документ.УвКонтрСд.СвКонтрСд.КонтрСд.КодИстИнф value) {
                ...
                public static class ОснКонтрСд {
                    ...
                    protected Файл.Документ.УвКонтрСд.СвКонтрСд.ОснКонтрСд.Осн10514 осн10514;
                    @XmlElement(name = "ОснРФ105.14", required = true)
                    protected Файл.Документ.УвКонтрСд.СвКонтрСд.ОснКонтрСд.ОснРФ10514 оснРФ10514;
                    @XmlAttribute(name = "ВзЗавис")
                    protected String взЗавис;

                    public Файл.Документ.УвКонтрСд.СвКонтрСд.ОснКонтрСд.Осн10514 getОсн10514() {
                        return осн10514;
                    }
                    public void setОсн10514(Файл.Документ.УвКонтрСд.СвКонтрСд.ОснКонтрСд.Осн10514 value) {
                        this.осн10514 = value;
                    }
                    public Файл.Документ.УвКонтрСд.СвКонтрСд.ОснКонтрСд.ОснРФ10514 getОснРФ10514() {
                        return оснРФ10514;
                    }
                    public void setОснРФ10514(Файл.Документ.УвКонтрСд.СвКонтрСд.ОснКонтрСд.ОснРФ10514 value) {
                ...
                public static class СвПредмСдН {
                    ...
                    protected List<Файл.Документ.УвКонтрСд.СвКонтрСд.СвПредмСдН.ПерПредСд> перПредСд;

                    @XmlAttribute(name = "ТипПредСд", required = true)
                    protected String типПредСд;

                    public List<Файл.Документ.УвКонтрСд.СвКонтрСд.СвПредмСдН.ПерПредСд> getПерПредСд() {
                        if (перПредСд == null) {
                            перПредСд = new ArrayList<Файл.Документ.УвКонтрСд.СвКонтрСд.СвПредмСдН.ПерПредСд>();
                        }
                        return this.перПредСд;
                    }
                    public void setПерПредСд(List<Файл.Документ.УвКонтрСд.СвКонтрСд.СвПредмСдН.ПерПредСд> value){
                ...
                public static class СвФЛУчаст {
                    ...
                    @XmlElement(name = "СвФЛ")
                    protected Файл.Документ.УвКонтрСд.СвКонтрСд.СвФЛУчаст.СвФЛ свФЛ;
                    ...
                    public Файл.Документ.УвКонтрСд.СвКонтрСд.СвФЛУчаст.СвФЛ getСвФЛ() {
                        return свФЛ;
                    }
                    public void setСвФЛ(Файл.Документ.УвКонтрСд.СвКонтрСд.СвФЛУчаст.СвФЛ value) {
                        this.свФЛ = value;
                    }
                    public BigInteger getНомПорСд() {
                        return номПорСд;
