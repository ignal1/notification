...
public class ‘айл {
    ...
    protected ‘айл.ƒокумент документ;
    ...
    public ‘айл.ƒокумент getƒокумент() {
        return документ;
    }
    public void setƒокумент(‘айл.ƒокумент value) {
        this.документ = value;
    }
    ...
    public static class ƒокумент {
        ...
        protected ‘айл.ƒокумент.—вЌѕ свЌѕ;
        @XmlElement(name = "ѕодписант", required = true)
        protected ‘айл.ƒокумент.ѕодписант подписант;
        @XmlElement(name = "”в онтр—д", required = true)
        protected ‘айл.ƒокумент.”в онтр—д ув онтр—д;
        ...
        public ‘айл.ƒокумент.—вЌѕ get—вЌѕ() {
            return свЌѕ;
        }
        public void set—вЌѕ(‘айл.ƒокумент.—вЌѕ value) {
            this.свЌѕ = value;
        }
        public ‘айл.ƒокумент.ѕодписант getѕодписант() {
            return подписант;
        }
        public void setѕодписант(‘айл.ƒокумент.ѕодписант value) {
            this.подписант = value;
        }
        public ‘айл.ƒокумент.”в онтр—д get”в онтр—д() {
            return ув онтр—д;
        }
        public void set”в онтр—д(‘айл.ƒокумент.”в онтр—д value) {
        ...
        public static class ѕодписант {
            ...
            protected ‘айл.ƒокумент.ѕодписант.—вѕред свѕред;
            ...
            public ‘айл.ƒокумент.ѕодписант.—вѕред get—вѕред() {
                return свѕред;
            }
            public void set—вѕред(‘айл.ƒокумент.ѕодписант.—вѕред value) {
                this.свѕред = value;
            }
        ...
        public static class —вЌѕ {
            ...
            protected ‘айл.ƒокумент.—вЌѕ.ЌѕёЋ нпюл;
            @XmlElement(name = "Ќѕ‘Ћ")
            protected ‘айл.ƒокумент.—вЌѕ.Ќѕ‘Ћ нпфл;
            ...
            public ‘айл.ƒокумент.—вЌѕ.ЌѕёЋ getЌѕёЋ() {
                return нпюл;
            }
            public void setЌѕёЋ(‘айл.ƒокумент.—вЌѕ.ЌѕёЋ value) {
                this.нпюл = value;
            }
            public ‘айл.ƒокумент.—вЌѕ.Ќѕ‘Ћ getЌѕ‘Ћ() {
                return нпфл;
            }
            public void setЌѕ‘Ћ(‘айл.ƒокумент.—вЌѕ.Ќѕ‘Ћ value) {
                this.нпфл = value;
            }
            ...
            public static class Ќѕ‘Ћ {
                ...
                @XmlElement(name = "—в‘Ћ")
                protected ‘айл.ƒокумент.—вЌѕ.Ќѕ‘Ћ.—в‘Ћ св‘Ћ;
                ...
                public ‘айл.ƒокумент.—вЌѕ.Ќѕ‘Ћ.—в‘Ћ get—в‘Ћ() {
                    return св‘Ћ;
                }
                public void set—в‘Ћ(‘айл.ƒокумент.—вЌѕ.Ќѕ‘Ћ.—в‘Ћ value) {
                    this.св‘Ћ = value;
                }
            ...
            public static class ЌѕёЋ {
                ...
                protected ‘айл.ƒокумент.—вЌѕ.ЌѕёЋ.—в–еоргёЋ св–еоргёЋ;
                ...
                public ‘айл.ƒокумент.—вЌѕ.ЌѕёЋ.—в–еоргёЋ get—в–еоргёЋ() {
                    return св–еоргёЋ;
                }
                public void set—в–еоргёЋ(‘айл.ƒокумент.—вЌѕ.ЌѕёЋ.—в–еоргёЋ value) {
        ...
        public static class ”в онтр—д {
            ...
            @XmlElement(name = "—в онтр—д", required = true)
            protected List<‘айл.ƒокумент.”в онтр—д.—в онтр—д> св онтр—д;

            public List<‘айл.ƒокумент.”в онтр—д.—в онтр—д> get—в онтр—д() {
                if (св онтр—д == null) {
                    св онтр—д = new ArrayList<‘айл.ƒокумент.”в онтр—д.—в онтр—д>();
                }
                return this.св онтр—д;
            }

            public void set—в онтр—д(List<‘айл.ƒокумент.”в онтр—д.—в онтр—д> value) {
            ...
            public static class —в онтр—д {
                ...
                protected ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д осн онтр—д;
                @XmlElement(name = " онтр—д", required = true)
                protected ‘айл.ƒокумент.”в онтр—д.—в онтр—д. онтр—д контр—д;
                @XmlElement(name = "ƒох–асх—д", required = true)
                protected ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ƒох–асх—д дох–асх—д;
                @XmlElement(name = "—вѕредм—дЌ", required = true)
                protected List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ> свѕредм—дЌ;
                @XmlElement(name = "—вќрг”част")
                protected List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вќрг”част> свќрг”част;
                @XmlElement(name = "—в‘Ћ”част")
                protected List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част> св‘Ћ”част;
                ...
                public ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д getќсн онтр—д() {
                    return осн онтр—д;
                }
                public void setќсн онтр—д(‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д value) {
                    this.осн онтр—д = value;
                }
                public ‘айл.ƒокумент.”в онтр—д.—в онтр—д. онтр—д get онтр—д() {
                    return контр—д;
                }
                public void set онтр—д(‘айл.ƒокумент.”в онтр—д.—в онтр—д. онтр—д value) {
                    this.контр—д = value;
                }
                public ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ƒох–асх—д getƒох–асх—д() {
                    return дох–асх—д;
                }
                public void setƒох–асх—д(‘айл.ƒокумент.”в онтр—д.—в онтр—д.ƒох–асх—д value) {
                    this.дох–асх—д = value;
                }

                public List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ> get—вѕредм—дЌ() {
                    if (свѕредм—дЌ == null) {
                        свѕредм—дЌ = new ArrayList<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ>();
                    }
                    return this.свѕредм—дЌ;
                }
                public void set—вѕредм—дЌ(List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ> value){
                    this.свѕредм—дЌ = value;
                }

                public List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вќрг”част> get—вќрг”част() {
                    if (свќрг”част == null) {
                        свќрг”част = new ArrayList<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вќрг”част>();
                    }
                    return this.свќрг”част;
                }
                public void set—вќрг”част(List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вќрг”част> value){
                    this.свќрг”част = value;
                }

                public List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част> get—в‘Ћ”част() {
                    if (св‘Ћ”част == null) {
                        св‘Ћ”част = new ArrayList<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част>();
                    }
                    return this.св‘Ћ”част;
                }
                public void set—в‘Ћ”част(List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част> value){
                ...
                public static class  онтр—д {
                    ...
                    protected ‘айл.ƒокумент.”в онтр—д.—в онтр—д. онтр—д. од»ст»нф код»ст»нф;
                    ...
                    public ‘айл.ƒокумент.”в онтр—д.—в онтр—д. онтр—д. од»ст»нф get од»ст»нф() {
                        return код»ст»нф;
                    }
                    public void set од»ст»нф(‘айл.ƒокумент.”в онтр—д.—в онтр—д. онтр—д. од»ст»нф value) {
                ...
                public static class ќсн онтр—д {
                    ...
                    protected ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн10514 осн10514;
                    @XmlElement(name = "ќсн–‘105.14", required = true)
                    protected ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн–‘10514 осн–‘10514;
                    @XmlAttribute(name = "¬з«авис")
                    protected String вз«авис;

                    public ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн10514 getќсн10514() {
                        return осн10514;
                    }
                    public void setќсн10514(‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн10514 value) {
                        this.осн10514 = value;
                    }
                    public ‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн–‘10514 getќсн–‘10514() {
                        return осн–‘10514;
                    }
                    public void setќсн–‘10514(‘айл.ƒокумент.”в онтр—д.—в онтр—д.ќсн онтр—д.ќсн–‘10514 value) {
                ...
                public static class —вѕредм—дЌ {
                    ...
                    protected List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ.ѕерѕред—д> перѕред—д;

                    @XmlAttribute(name = "“ипѕред—д", required = true)
                    protected String типѕред—д;

                    public List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ.ѕерѕред—д> getѕерѕред—д() {
                        if (перѕред—д == null) {
                            перѕред—д = new ArrayList<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ.ѕерѕред—д>();
                        }
                        return this.перѕред—д;
                    }
                    public void setѕерѕред—д(List<‘айл.ƒокумент.”в онтр—д.—в онтр—д.—вѕредм—дЌ.ѕерѕред—д> value){
                ...
                public static class —в‘Ћ”част {
                    ...
                    @XmlElement(name = "—в‘Ћ")
                    protected ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част.—в‘Ћ св‘Ћ;
                    ...
                    public ‘айл.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част.—в‘Ћ get—в‘Ћ() {
                        return св‘Ћ;
                    }
                    public void set—в‘Ћ(‘айл.ƒокумент.”в онтр—д.—в онтр—д.—в‘Ћ”част.—в‘Ћ value) {
                        this.св‘Ћ = value;
                    }
                    public BigInteger getЌомѕор—д() {
                        return номѕор—д;
